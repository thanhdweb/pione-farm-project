...
import LocationSelector from "@/components/layout/locationselector/LocationSelector";
import StatisticsChart from "@/components/layout/statisticschart/StatisticsChart";
import AgriPriceSearch from "@/components/layout/agripricesearch/AgriPriceSearch";
import PriceTable from "@/components/layout/pricetable/PriceTable";
  ...
  return (
    <div>
      <Header backgroundUrl="/images/image 10.png">
        <p className="text-sm sm:text-sm text-[var(--green)] font-semibold mb-2">
          Blockchain Và AI
        </p>
