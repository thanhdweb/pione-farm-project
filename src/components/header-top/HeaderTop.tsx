    ...
    return (
        <div className="w-full">
            ...
            <div className='flex items-center gap-2 py-5 pl-4 md:pl-12 float-left'>
                <Image src="/icons/Icon.svg" alt="Logo" width={30} height={30} className="rounded-full" />
                <span className="font-bold text-xl md:text-2xl text-gray-900">BlockchainFarm</span>
            </div>

            {/* khi desktop show right */}
            <div className="hidden md:flex items-center gap-6 pt-6 pb-4 px-4 md:px-12 float-right bg-white rounded-bl-full shadow-md">
                {/* Search icon */}
                <button>
                    <svg
                ...
                <div className="relative" ref={dropdownRef}>
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-gray-900">Marci Fumons</span>
                        <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path fill="gray" fillRule="evenodd" clipRule="evenodd" d="M6.399 9.399a.85.85 0 0 1 1.202 0L12 13.798l4.399-4.399a.85.85 0 0 1 1.202 1.202l-5 5a.85.85 0 0 1-1.202 0l-5-5a.85.85 0 0 1 0-1.202" />
                        </svg>
                    </div>
                    ...
                    {showDropdown && (
                        <ul className="absolute right-0 mt-2 w-38 bg-white border border-gray-200 rounded-lg shadow-md z-50">
                            <li>
                                <a href="#" className="block p-2 text-sm text-gray-700 hover:bg-gray-100">Thông tin cá nhân</a>
                            </li>
                            <li>
                                <a href="#" className="block p-2 text-sm text-gray-700 hover:bg-gray-100">Cài đặt</a>
                            </li>
                            <li>
                                <a href="/logout" className="block p-2 text-sm text-red-600 hover:bg-red-100">Đăng xuất</a>
                            </li>
                        </ul>
                    )}
                </div>
            ...
            {/* tôi nghỉ chổ này sẻ là ẩn hiện icon menu và show nav  */}
            <div className="md:hidden float-right p-4 bg-white rounded-bl-full shadow-md">
            ...
            {isMobileOpen && <MobileNavbar isOpen={isMobileOpen} onClose={() => setIsMobileOpen(false)} />}
