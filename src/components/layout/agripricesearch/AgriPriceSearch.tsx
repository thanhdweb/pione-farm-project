...
export default function PriceFilterForm() {
  ...
  return (
    <div
      className="bg-white rounded-3xl px-6 pt-8 pb-10"
      ...
      <div className="flex flex-wrap gap-4 mt-4 items-center justify-between">
        ...
        <div className="relative">
          <Input
            ...
            className="w-[297px] px-4 pr-10 py-2 text-sm rounded-full border-gray-400 outline-none hover:border-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-400 focus:border-transparent"
          />
          <svg
